...
// CALTECHCS-NOTE:
// This anchor is used to force the linker to link the CaltechCSModule.
extern volatile int CaltechCSModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED CaltechCSModuleAnchorDestination =
    CaltechCSModuleAnchorSource;
