...
class DereferenceChecker
  ...
  BugType BT_Null{
    this,
    "You are trying to access a value through a pointer that might be null. "
    "Make sure you're considering all cases that might cause the pointer to be "
    "null, including memory allocation failure.", categories::LogicError};
